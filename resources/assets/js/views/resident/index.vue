	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="info" v-on:click="getResidentList"><i class="fa fa-search"></i> 查询</el-button>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="users" stripe @selection-change="selsChange" style="100%">
			...
			<el-table-column prop="identify" label="身份证号码" width="200"></el-table-column>
			<el-table-column prop="address" label="所在行政村"></el-table-column>
			<el-table-column prop="age" width="85" label="年龄"></el-table-column>
			<el-table-column prop="sex" width="85" label="性别" sortable>
...
<script>
	import { getResidentList, deleteUser } from '../../api/api'
	export default {
		data () {
			return {
				users: [],
